...
const ao: ChoiceOption[] = [
  ...
  { id: 10, name: "ЗелАО", unavailable: true },
  { id: 11, name: "ТАО", unavailable: true },
  { id: 12, name: "НАО", unavailable: true },
...
const area: ChoiceOption[] = [
  ...
  { id: 58, name: "Выхино-Жулебино", unavailable: true, scale: 0.89, parentId: 5 },
  { id: 59, name: "Капотня", unavailable: true, scale: 0.9, parentId: 5 },
  { id: 60, name: "Кожухово", unavailable: true, scale: 0.72, parentId: 5 },
  { id: 61, name: "Кузьминки", unavailable: true, scale: 0.98, parentId: 5 },
  { id: 62, name: "Лефортово", unavailable: true, scale: 0.97, parentId: 5 },
  { id: 63, name: "Люблино", unavailable: true, scale: 0.91, parentId: 5 },
  { id: 64, name: "Марьино", unavailable: true, scale: 0.91, parentId: 5 },
  { id: 65, name: "Некрасовка пос.", unavailable: false, scale: 0.56, parentId: 5 },
  { id: 66, name: "Печатники", unavailable: true, scale: 0.89, parentId: 5 },
  { id: 67, name: "Рязанский", unavailable: true, scale: 0.92, parentId: 5 },
  { id: 68, name: "Текстильщики", unavailable: true, scale: 0.92, parentId: 5 },
  { id: 69, name: "Южнопортовый", unavailable: true, scale: 0.92, parentId: 5 },
  ...
  { id: 119, name: "Район Матушкино", unavailable: true, scale: 0.73, parentId: 10 },
  { id: 120, name: "Район Савелки", unavailable: true, scale: 0.74, parentId: 10 },
  { id: 121, name: "Район Силино", unavailable: true, scale: 0.69, parentId: 10 },
  { id: 122, name: "Район Старое Крюково", unavailable: true, scale: 0.75, parentId: 10 },
  { id: 123, name: "Вороновское", unavailable: true, scale: 0.48, parentId: 11 },
  { id: 124, name: "Киевский", unavailable: true, scale: 0.52, parentId: 11 },
  { id: 125, name: "Кленовское", unavailable: true, scale: 0.48, parentId: 11 },
  { id: 126, name: "Краснопахорское", unavailable: true, scale: 0.56, parentId: 11 },
  { id: 127, name: "Михайлово-Ярцевское", unavailable: true, scale: 0.51, parentId: 11 },
  { id: 128, name: "Новофедоровское", unavailable: true, scale: 0.52, parentId: 11 },
  { id: 129, name: "Первомайское", unavailable: true, scale: 0.6, parentId: 11 },
  { id: 130, name: "Роговское", unavailable: true, scale: 0.4, parentId: 11 },
  { id: 131, name: "Троицк", unavailable: true, scale: 0.64, parentId: 11 },
  { id: 132, name: "Щаповское", unavailable: true, scale: 0.51, parentId: 11 },
  { id: 133, name: "Внуковское", unavailable: true, scale: 0.75, parentId: 12 },
  { id: 134, name: "Воскресенское", unavailable: true, scale: 0.66, parentId: 12 },
  { id: 135, name: "Десеновское", unavailable: true, scale: 0.66, parentId: 12 },
  { id: 136, name: "Кокошкино", unavailable: true, scale: 0.6, parentId: 12 },
  { id: 137, name: "Марушкинское", unavailable: true, scale: 0.6, parentId: 12 },
  { id: 138, name: "Московский", unavailable: true, scale: 0.82, parentId: 12 },
  { id: 139, name: "Мосрентген", unavailable: true, scale: 0.83, parentId: 12 },
  { id: 140, name: "Рязановское", unavailable: true, scale: 0.66, parentId: 12 },
  { id: 141, name: "Сосенское", unavailable: true, scale: 0.83, parentId: 12 },
  { id: 142, name: "Филимоновское", unavailable: true, scale: 0.77, parentId: 12 },
  { id: 143, name: "Щербинка", unavailable: true, scale: 0.71, parentId: 12 },
